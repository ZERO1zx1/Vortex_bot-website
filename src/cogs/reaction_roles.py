...
"""
from src.utils.constants import SUCCESS_COLOR, WARNING_COLOR, INFO_COLOR
from src.utils.supabase_cog import SupabaseCog
from src.utils.i18n import t_direct, get_guild_lang, get_guild_lang_sync
import discord
...
class ReactionRoles(SupabaseCog):
    ...
    async def cog_load(self):
        ...
        try:
            ...
            logger.warning("reaction_roles хүснэгт олдсонгүй: %s — migration ажиллуул: 20260813_002_missing_tables.sql", exc)
