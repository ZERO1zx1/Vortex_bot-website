...
(() => {
  ...
  /* Debounce: render()-ийг 80мс-ийн дараа хийнэ — 153 карт бүр дарах бүр зурагдахгүй (WI3) */
...
const AETHER_I18N = {
  mn: {
    ...
    'about.p2': 'Эдийн засаг, түвшин, гэрлэл, дэлгүүр, казино, mafia, модерац — 35 cog, 153 команд бүгд нэг системд. Supabase (PostgreSQL) backend-ээр 24/7 бат бөх ажиллана.',
    'about.q': 'Бид бол',
    ...
    'cl.v22_d': 'Командын картнууд, badge-ууд, хайлтын input 390px утасны дэлгэцэд бүрэн цэгцтэй болсон. 153 команд бүгдийн MN/EN тайлбартай.',
  ...
  en: {
    ...
    'about.p2': 'Economy, leveling, marriage, shop, casino, mafia, moderation — 35 cogs and 153 commands in one system. Supabase (PostgreSQL) backend keeps it running 24/7.',
    'about.q': 'Who we are',
    'about.tag': 'ABOUT US',
    'community.active': 'Active Community',
    ...
    'cl.v22_d': 'Command cards, badges, and search input look clean on 390px phones. All 153 commands have MN/EN descriptions.',
