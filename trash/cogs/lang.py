...
from src.utils.constants import DEFAULT_PREFIX, EMBED_COLOR, SUCCESS_COLOR, ERROR_COLOR, WARNING_COLOR, GOLD_COLOR, INFO_COLOR
from src.utils.branding import footer_text
