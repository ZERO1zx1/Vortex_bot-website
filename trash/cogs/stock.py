...
try:
    from src.cogs.shop import SHOP_ITEMS, ALL_VAPE_COMBOS
except ImportError:
    SHOP_ITEMS = []
    ALL_VAPE_COMBOS = {}
    logger.warning("src.cogs.shop идэвхгүй, хоосон утга ашиглаж байна.")

try:
    from src.cogs.cafe import Cafe
    CAFE_MENU = Cafe.menu if hasattr(Cafe, 'menu') else []
except ImportError:
    CAFE_MENU = []
    logger.warning("src.cogs.cafe идэвхгүй, хоосон утга ашиглаж байна.")
